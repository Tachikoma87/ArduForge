...
* MPU6050 - very common 6-axis (3 DOF acceleration, 3 DOF rotation) inertial measuring unit (IMU)
* RotaryEncoder - tracks the rotation of a shaft and usually comes with a switch

# Examples
All examples use the serial port with a speed setting pf 115200.
